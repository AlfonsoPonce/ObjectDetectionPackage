...
YOLO_CLASSES = ['Drone']
## path root folder
ROOT = '/home/getec/PycharmProjects/PipelineV3/input/drone_dataset/train/'
...
def yolo2voc(root, classes, log_object = None):
    class_path = join(root, 'yolo_labels')
    ids = list()
    ...
    annopath = join(root, 'yolo_labels', '%s.txt')
