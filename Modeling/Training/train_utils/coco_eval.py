'''
Module that implements coco evaluation functionality.
...
class CocoEvaluator:
    ...
    def summarize(self):
        '''
        Function that returns metric summary
        :return:
        '''
    ...
    def prepare_for_coco_segmentation(self, predictions):
        '''
        Function that prepares coco segmentation
        :param predictions: list of label predictions
        :return:
        '''
        coco_results = []
    ...
    def prepare_for_coco_keypoint(self, predictions):
        '''
        Function that prepares coco keypoints detection
        :param predictions: list of label predictions
        :return:
        '''
        coco_results = []
...
def convert_to_xywh(boxes):
    '''
    Conversion of bbox detection.
    :param boxes: bbox detection.
    :return:
    '''
...
def merge(img_ids, eval_imgs):
    '''
    Function that merges image ground truth and image to evaluate
    :param img_ids: Ground truth images
    :param eval_imgs: Evaluation images
    :return:
    '''
...
def create_common_coco_eval(coco_eval, img_ids, eval_imgs):
    '''
    Function that creates coco evaluation
    :param coco_eval: coco object to perform evaluation
    :param img_ids: ground truth image ids
    :param eval_imgs: images to be evaluated
    :return:
    '''
...
def evaluate(imgs):
    '''
    Function that performs images evaluations
    :param imgs: images to be evaluated
    :return:
    '''
    with redirect_stdout(io.StringIO()):
        imgs.evaluate()
