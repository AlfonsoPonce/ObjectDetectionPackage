'''
Module that implements training and evaluation behaviour.
...
def train_one_epoch(
    ...
    '''
    Function that implements one training epoch
    :param model: torch object detection model
    :param optimizer: torch optimizer
    :param data_loader: train data loader
    :param device: device the model will be set
    :param epoch: current epoch number
    :param train_loss_hist: list of training loss over epochs
    :param print_freq: training loss print frequency over batches
    :param scaler:
...
def evaluate(model, data_loader, device):
    '''
    Function that implements evaluation
